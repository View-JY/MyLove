  			...
  			<div class="col-xs-12">
	  			...
	  			<form action="" method="post" accept-charset="utf-8" class="form-horizontal">
	  				...
	  				<div class="form-group form-group-lg">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" id="formGroupInputLarge" placeholder="输入标题" name="title" required />
						</div>
					</div>
					<!-- 文章分类 -->
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-10">
							<label class="category">
	    						<input type="radio" name="category_id" id="optionsRadios1" value="1">
	    						<span>两性夜话</span>
	  						</label>
  						</div>
					</div>
                    ...
                    <!-- 确认并发布 -->
                    <button type="submit" class="btn btn-primary btn-lg pull-left">确认并发布</button>
	  			</form>
  			</div>
  		</div>
  	</div>
